...
const ServiceCard: React.FC<ServiceCardProps> = ({ Icon, title, description }) => {
  return (
    <div className="group p-10 bg-white rounded-xl shadow-[0_5px_20px_rgba(0,0,0,0.1)] transition-all duration-300 hover:-translate-y-2.5 hover:shadow-[0_15px_40px_rgba(0,0,0,0.15)] flex flex-col items-center text-center">
      ...
      <h4 className="font-['Roboto_Condensed'] text-xl mb-4 text-[#1a2332] group-hover:text-[#d4a574] transition-colors duration-300">{title}</h4>
      <p className="text-sm leading-relaxed text-[#8b9db0]">{description}</p>
    </div>
  );
};
...
export const Services: React.FC = () => {
  ...
  return (
    <div id="services" className="bg-[#f8f9fa] py-24 px-[10%]">
      <h4 className="font-['Roboto_Condensed'] text-[28px] font-light text-[#1a2332] uppercase tracking-[0.15em] mb-2.5 text-center">
        Services
      </h4>
      <div className="mb-16">
        <img
